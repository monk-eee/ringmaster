...
| [ADR-0013: HTTP endpoints trigger and list model-based extraction candidates](0013-http-endpoints-trigger-and-list-extraction-candidates.md) | Proposed | [EV-0013](../evidence.d/0013-http-endpoints-trigger-and-list-extraction-candidates.md) |